...
> **Note**
> Everywhere in this repository, make sure to replace `tulilirockz/Malachite` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/tulilirockz/Malachite/blob/main/scripts/README.md) for more information.
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/tulilirockz/Malachite:20230403
```
